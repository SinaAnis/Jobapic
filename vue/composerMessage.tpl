<!DOCTYPE html>
<!-- saved from url=(0050)http://squaredesigns.net/jasmine/mail-compose.html -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">



    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title> Composer un Message | Jasmine - Responsive admin template </title>
    ...
    <link href=" vue/css/css(1)" rel="stylesheet">
    ...
    <!--Switchery [ OPTIONAL ]-->
    <link href=" vue/css/switchery.min.css" rel="stylesheet">


    <!--Jquery Tag It [ OPTIONAL ]-->
    <link href=" vue/css/jquery.tagit.css" rel="stylesheet">


    <!--Bootstrap Select [ OPTIONAL ]-->
    <link href=" vue/css/bootstrap-select.min.css" rel="stylesheet">

    <!--Chosen [ OPTIONAL ]-->
    <link href=" vue/css/chosen.min.css" rel="stylesheet">

    <!--Summernote [ OPTIONAL ]-->
    <link href=" vue/css/summernote.min.css" rel="stylesheet">
    ...
    <link href=" vue/css/pace.min.css" rel="stylesheet">
    <script src=" vue/js/pace.min.js"></script><script type="text/javascript">try {
...
<body class="page-effect  pace-done"><div class="pace  pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="width: 100%;">
...
<div class="pace-activity"></div></div>
        ...
        <div class="boxed">
            ...
            <section id="content-container">
                ...
                <header class="pageheader">
                    <h3><i class="fa fa-home"></i> Composer un Message </h3>
                    <div class="breadcrumb-wrapper"> <span class="label">Vous êtes ici:</span>
                        <ol class="breadcrumb">
                            <li> <a href="http://squaredesigns.net/jasmine/mail-compose.html#"> Home </a> </li>
                            <li class="active"> Composer un Message </li>
                        </ol>
                    </div>
                </header>
                ...
                <div id="page-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-3 col-lg-3">
                            <section class="mail-categories">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <a href="javascript:;"> <i class="fa fa-inbox"></i> Messagerie <span class="label label-info pull-right">6</span> </a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href="javascript:;"> <i class="fa fa-envelope-o"></i> Composer un Message </a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href="javascript:;"> <i class="fa fa-star"></i> Favoris <span class="label label-danger pull-right">3</span> </a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href="javascript:;"> <i class="fa fa-comment-o"></i> Chat <span class="label label-success pull-right">9</span> </a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href="javascript:;"> <i class="fa fa-pencil"></i> Brouillons <span class="label label-warning pull-right">1</span> </a>
                                    </li>
                                    <li class="list-group-item">
                            ...
                            <section class="mail-categories">
                                <ul class="list-group">
                                    <li class="list-group-item"><a href="javascript:;"> Annonce 1 <i class="fa fa-circle pull-right"></i> </a></li>
                                    <li class="list-group-item"><a href="javascript:;"> Annonce 2 <i class="fa fa-circle pull-right"></i> </a></li>
                                    <li class="list-group-item"><a href="javascript:;"> Annonce 3 <i class="fa fa-circle pull-right"></i> </a></li>
                                    <li class="list-group-item"><a href="javascript:;"> Annonce 4 <i class="fa fa-circle pull-right"></i> </a></li>
                                    ...
                                    <ul class="list-inline">
                                        <li>
                                          <a href="javascript:void(0)" class="pull-left avatar">
                                             <img src="./Mail Compose _ Jasmine - Responsive admin template_files/av1.png" alt="" class="img-sm">
                                             <i class="on bottom text-light"></i>
                                          </a>
                                        </li>
                                        <li>
                                          <a href="javascript:void(0)" class="pull-left avatar">
                                             <img src="./Mail Compose _ Jasmine - Responsive admin template_files/av2.png" alt="" class="img-sm">
                                             <i class="on bottom text-light"></i>
                                          </a>
                                        </li>
                                        <li>
                                          <a href="javascript:void(0)" class="pull-left avatar">
                                             <img src="./Mail Compose _ Jasmine - Responsive admin template_files/av3.png" alt="" class="img-sm">
                                             <i class="busy bottom text-light"></i>
                                          </a>
                                        </li>
                                        <li>
                                          <a href="javascript:void(0)" class="pull-left avatar">
                                             <img src="./Mail Compose _ Jasmine - Responsive admin template_files/av4.png" alt="" class="img-sm">
                                             <i class="busy bottom text-light"></i>
                                          </a>
                                        </li>
                                        <li>
                                          <a href="javascript:void(0)" class="pull-left avatar">
                                             <img src="./Mail Compose _ Jasmine - Responsive admin template_files/av5.png" alt="" class="img-sm">
                                             <i class="on bottom text-light"></i>
                                          </a>
                                        </li>
                                        <li>
                                          <a href="javascript:void(0)" class="pull-left avatar">
                                             <img src="./Mail Compose _ Jasmine - Responsive admin template_files/av6.png" alt="" class="img-sm">
                                             <i class="on bottom text-light"></i>
                                          </a>
                                        </li>
                                        <li>
                                          <a href="javascript:void(0)" class="pull-left avatar">
                                             <img src="./Mail Compose _ Jasmine - Responsive admin template_files/av7.png" alt="" class="img-sm">
                                             <i class="busy bottom text-light"></i>
                                          </a>
                                        </li>
                                        <li>
                        ...
                        <div class="col-xs-12 col-md-9 col-lg-9">
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <form  class="form-horizontal form-bordered" action="index.php?controle=composerMessage&action=creerMessage" method="post">
                                        <div class="form-group nb">
                                            <label class="control-label col-md-1">A : </label>
                                            <div class="col-md-11">
                                                <!-- <ul id="jquery-tagIt-white" class="tagit ui-widget ui-widget-content ui-corner-all">  -->
                                              <!--  <li name="destinataire" class="tagit-new"> --> <input type="text" autocomplete="off" name="destinataire">
                                            <!-- </li> -->
                                              <!-- </ul> -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group nb">
                                            <label class="control-label col-md-1">Objet : </label>
                                            <div class="col-md-11">
                    ...
                    <div class="nano has-scrollbar">
                        <div class="nano-content" tabindex="0" style="right: -17px;">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                <li class="active">
                                    <a href="http://squaredesigns.net/jasmine/mail-compose.html#demo-asd-tab-1" data-toggle="tab"> <i class="fa fa-comments"></i> </a>
                                </li>
                                <li>
                                    <a href="http://squaredesigns.net/jasmine/mail-compose.html#demo-asd-tab-3" data-toggle="tab"> <i class="fa fa-wrench"></i> </a>
                                </li>
                            </ul>
                            <!--================================-->
                            <!--End nav tabs-->
                                    ...
                                    <ul class="list-group bg-trans">
                                        ...
                                        <li class="list-group-item">
                                           <div class="pull-right">
                                              <input class="demo-switch" type="checkbox" checked="" data-switchery="true" style="display: none;"><span class="switchery switchery-default" style="background-color: rgb(100, 189, 99); border-color: rgb(100, 189, 99); box-shadow: rgb(100, 189, 99) 0px 0px 0px 0px inset; transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;"><small style="left: 20px; background-color: rgb(255, 255, 255); transition: left 0.2s;"></small></span>
                                           </div>
                                        ...
                                        <li class="list-group-item">
                                           <div class="pull-right">
                                              <input class="demo-switch" type="checkbox" data-switchery="true" style="display: none;"><span class="switchery switchery-default" style="box-shadow: rgb(223, 223, 223) 0px 0px 0px 0px inset; border-color: rgb(223, 223, 223); background-color: rgb(255, 255, 255); transition: border 0.4s, box-shadow 0.4s;"><small style="left: 0px; background-color: rgb(255, 255, 255); transition: left 0.2s;"></small></span>
                                           </div>
                                           <p>Invisible mode </p>
                                           <small class="text-muted">Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</small>
                                        </li>
    ...
    <!--jQuery UI [ REQUIRED ]-->
    <script src="vue/js/jquery-ui.min.js "></script>
    ...
    <!--Fast Click [ OPTIONAL ]-->
    <script src="vue/js/fastclick.min.js "></script>

    <!--Jasmine Admin [ RECOMMENDED ]-->
    <script src="vue/js/scripts.js "></script>

    <!--Switchery [ OPTIONAL ]-->
    <script src=" vue/js/switchery.min.js "></script>

    <!--Bootstrap Select [ OPTIONAL ]-->
    <script src=" vue/js/bootstrap-select.min.js "></script>

    <!--Chosen [ OPTIONAL ]-->
    <script src=" vue/js/chosen.jquery.min.js "></script>

    <!--Bootstrap Tags Input [ OPTIONAL ]-->
    <script src=" vue/js/tag-it.min.js "></script>

    <!--Demo script [ DEMONSTRATION ]-->
    <script src=" vue/js/jasmine.js "></script>

    <!--Summernote [ OPTIONAL ]-->
    <script src=" vue/js/summernote.min.js "></script>

    <!--Demo script [ DEMONSTRATION ]-->
    <script src=" vue/js/mail-compose.js "></script>
