...
<head>
    ...
    <title>Modifier le profil | Job'aPic - Enfin un job à pic.</title>
                                ...
                                <div class="panel-body">
                                    <!-- START Form Wizard -->
                                        ...
                                        <div class="wizard-container">
                                            ...
                                            <form action="./index.php?controle=editerProfil&action=editerProfilEmploye" method="post">
                                            <div class="form-group">
