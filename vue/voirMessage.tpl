<!DOCTYPE html>
<!-- saved from url=(0051)http://squaredesigns.net/jasmine/mail-mailview.html -->
                ...
                <div id="page-content">
                    <div class="row">
                        <div class="col-xs-12 col-md-3 col-lg-3  hidden-xs">
                            <div class="pad-all">
                                <a href="http://squaredesigns.net/jasmine/mail-mailview.html#/mail/compose" class="btn btn-danger btn-block btn-md"> <span class="fa fa-edit"></span> POSTER </a>
                            </div>
                                ...
                                <div class="btn-toolbar pad-all">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="http://squaredesigns.net/jasmine/mail-mailview.html#">Action</a> </li>
                                            <li><a href="http://squaredesigns.net/jasmine/mail-mailview.html#">Another action</a> </li>
                                            <li><a href="http://squaredesigns.net/jasmine/mail-mailview.html#">Something else here</a> </li>
                                            <li class="divider"></li>
                    ...
                    <div class="nano has-scrollbar">
                        <div class="nano-content" tabindex="0" style="right: -17px;">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                <li class="active">
                                    <a href="http://squaredesigns.net/jasmine/mail-mailview.html#demo-asd-tab-1" data-toggle="tab"> <i class="fa fa-comments"></i> </a>
                                </li>
                                <li>
                                    <a href="http://squaredesigns.net/jasmine/mail-mailview.html#demo-asd-tab-3" data-toggle="tab"> <i class="fa fa-wrench"></i> </a>
                                </li>
                            </ul>
                            <!--================================-->
                            <!--End nav tabs-->
