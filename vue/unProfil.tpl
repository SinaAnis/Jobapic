...
<head>
    ...
    <title> Un Profil | Job'Apic - Enfin un job à pic.</title>
        ...
        <div class="boxed">
            ...
            <section id="content-container">
                <header class="pageheader">
                    <h3><i class="fa fa-home"></i> Profil de <?php 
                    foreach($candidat as $key => $cand) {
                    $name = strtoupper($cand[1]);
                    $surname = ucfirst($cand[2]);
                    echo("$name $surname" ) ;}
                     ?></h3>
                    <div class="breadcrumb-wrapper"> <span class="label">Vous êtes ici:</span>
                        <ol class="breadcrumb">
							...
							<li class="active"> Consulter un profil </li>
                        </ol>
                    </div>
                </header>
                                ...
                                <div class="tab-pane fade" id="demo-asd-tab-3">
                                    <ul class="list-group bg-trans">
                                        ...
                                        <li class="list-group-item">
                                           ...
                                           <p>Montrer un statut personnel</p>
