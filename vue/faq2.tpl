...
<div style="margin-left: 14%; margin-top: 5%; margin-bottom: -3%" class="page-header">
    <h1>Job'aPic <small>les questions posés fréquemment</small></h1>
</div>

<!-- Bootstrap FAQ - START -->
<div style="width: 85%; height: auto; margin-left: 13%; margin-top: 5%;" class="container">
    <br />
    <br />
    <br />
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Je viens d’arriver sur le site et je ne comprends pas très bien les fonctionnalités

de l’application Job’Apic, quel est son fonctionnement ?</a>
                </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in">
                <div style="font-size: 17px" class="panel-body">
                    <strong>Job'aPic</strong> est une plateforme qui sert à la fois aux utilisateurs de publier des annonces, c'est à dire des petits services comme le babysitting, jardinage, ... 
                    Il permet aussi aux utilisateurs de postuler pour un service et gagner de l'argent.  
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTen">Pourquoi choisir Job’Apic ?</a>
                </h4>
            </div>
            <div id="collapseTen" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    Job'aPic, est une plateforme qui permet d'accélérer le procéssus de trouver un petit job ou bien de trouver quelqu'un pour faire ses tâches. 
					De plus les annonces sont filtrés selons vos catégories préférés, ce qui permet de cibler les annonces. 
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEleven">Est-ce que Job’Apic prend une partie de l’argent dans l’échange entre

l’employeur et l’employé ?</a>
                </h4>
            </div>
            <div id="collapseEleven" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    Il faut noter que la plateforme se charge de mettre en relation un employeur et un employé, notre service est donc totalement <strong>GRATUIT</strong>
                </div>
            </div>
        </div>
        ...
        <div class="faqHeader">Les Top Questions</div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Comment dois-je faire pour postuler à une annonce ?</a>
                </h4>
            </div>
            <div id="collapseTwo" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    Pour postuler à une annonce:
                    <ul>
                        <li>Cliquer sur l'annonce de votre choix</li>
                        <li>Cliquer sur le bouton postuler</li>
                    </ul>
					Vous pouvez également consulter nos tutos pour d'autres questions sur le fonctionnement du site. 
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Comment se déroule la suite du processus après qu’un employeur ait validé
...
mon annonce ?</a>
            ...
            <div id="collapseThree" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    Après qu'un employeur ait validé votre candidature, vous verrez que l'état de votre annonce passe de "en cours" à "validé". l'employeur peut éventuellement vous contacter via notre messagerie pour vous donner de plus ample informations. 
					Vous n'avez plus qu'à vous rendre sur place pour réaliser votre service.
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive">Qu’est-ce que je dois faire en cas d’arnaque après avoir exercé un petit
...
boulot ?</a>
            ...
            <div id="collapseFive" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    Vous pouvez portez plainte dans la partie plainte de notre site, nous nous chargerons de la suite.
                    <br />
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSix">Est-il possible d’annuler la candidature à une annonce après y avoir postulé ?</a>
                </h4>
            </div>
            <div id="collapseSix" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    Vous pouvez annuler votre candidature si celle-ci est validé, vous pouvez contacter au plus vite le recruteur pour lui signaler un empêchement.
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseEight">Est-ce qu’il est possible d’à la fois me positionner en tant qu’employé et à la

fois en tant qu’employeur ?</a>
                </h4>
            </div>
            <div id="collapseEight" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    Notre plateforme est à double facette, vous avez un compte pour deux status. Vous pouvez à tout moment passer d'un rôle à l'autre avec notre bouton switch. 
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseNine">Que dois-je faire si après la validation d'un candidat ce dernier ne vient pas ?</a>
                </h4>
            </div>
            <div id="collapseNine" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    Vous pouvez éventuellement le signaller dans la partie plainte de notre site, ce dernier sera averti ou sanctionné.  
                </div>
            </div>
        </div>
        ...
        <div class="faqHeader">Autres Questions</div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour">Est-ce que Job’Apic prend en charge des remboursements en qu’à d’arnaque,

de vol ou de travail non satisfaisant ?</a>
                </h4>
            </div>
            <div id="collapseFour" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    Job'aPic ne prend pas en charge ces cas car, un candidat est payer qu'à la fin de son service. Ce dernier doit donc être payer.
					Dans le cas où l'employeur trouve que la qualité du service n'est pas terrible ce dernier pourra exprimer ses impressions dans la partie note qui sera bientôt mis en place.
                </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a style="text-decoration: none" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven">Je suis mineur et j’aimerais proposer et exercer de petits boulots, est-ce
...
possible ?</a>
            ...
            <div id="collapseSeven" class="panel-collapse collapse">
                <div style="font-size: 17px" class="panel-body">
                    En tant que mineur vous ne pouvez pas exercer tous les services de tous les dommaines. 
					Par contre vous pouvez en proposer à tout moment tant qu'à la fin du service vous payer le candidat.
					Attention les moins de 14ans ne sont pas admis à tenir un compte dans cette plateforme.
                </div>
            </div>
        </div>
    </div>
