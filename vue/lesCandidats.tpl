...
<head>
    ...
    <title> Les candidatures et mes annonces | Job'Apic - Enfin un job à pic.</title>
        ...
        <div class="boxed">
            ...
            <section id="content-container">
                <header class="pageheader">
                    <h3 class="titre"><i class="fa fa-home"></i> Les candidatures </h3>
                    <div class="breadcrumb-wrapper"> <span class="label">Vous êtes ici:</span>
                        <ol class="breadcrumb">
                            <li> <a href="#"> Home </a> </li>
                            <li class="active"> <a href="#"> Profil </a>   </li>
                            <li class="active"> Les candidatures </li>
                        </ol>
                    </div>
                </header>
