                        ...
                        <div class="col-xs-12 col-md-9 col-lg-9">
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <form  class="form-horizontal form-bordered" action="index.php?controle=composerMessage&action=creerMessageEmployeur" method="post">
                                        <div class="form-group nb">
                                            ...
                                            <div class="col-md-11">
                                                ...
                                                <?php  foreach ($utilisateurs as $value) {
                                                    echo ("<OPTION value='".$value['IdUser']."'>".$value['Prenom']." ". $value['Nom']);
                                                }
                                                ?>
                                              </select>
                                              <!--  <li name="destinataire" class="tagit-new"> -->
                                            <!-- </li> -->
                                              <!-- </ul> -->
                                            </div>
                                        </div>
                                      ...
                                      -->
                                        <textarea name="textMes"  class="note-editable" contenteditable="true" style="height: 250px; width: 100%;" ></textarea>
